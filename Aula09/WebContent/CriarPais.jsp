...
<html lang="UTF-8">
	<head>
	    ...
	    <title>Explorer.biz - Criar Pais</title>
	        ...
	        <form action="controller.do" method="post">
	            ...
	            <div class="row">
	                <div class="form-group col-md-6">
	                    ...
	                    required maxlength="25" placeholder="digite a quantidade da populacao">
	                </div>
	
	                <div class="form-group col-md-6">
	                    <label for="area">Area</label>
	                    <input type="text" class="form-control" name="area" id="area" required maxlength="25" placeholder="tamanho da area em M²">
	                </div>
	            </div>
	            <hr />
